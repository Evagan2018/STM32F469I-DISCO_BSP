...
|:------------------------------|:------------------------------------------------------------------------------
| CMSIS_MCI                     | CMSIS-Driver MCI connected to microSD card slot (CN9)
| CMSIS_USB_Device              | CMSIS-Driver USB Device connected to USB_OTG_FS connector (CN13)
| CMSIS_VIO                     | CMSIS-Driver VIO connected to LEDs (LD3, LD1, LD4, LD2) and Wake-up button (B2)
...
By default the [Board Layers](https://github.com/Open-CMSIS-Pack/STM32F469I-DISCO_BSP/tree/main/Layers) are configured for the Arm Compiler 6 (AC6). Using STM32CubeMX it can be reconfigured for a different compiler. To configure it for the GCC compiler execute these steps:
